<template>
  <div class="bg-white">
    <h2 class="mb-14 pt-14 text-2xl font-bold text-red-800 text-center">Menu a la carta</h2>
...
const menues_carta = ref(["Entrantes", "Pescado", "Carnes", "Postres"]);
...
.grid-container {
  ...
  gap: 60px; /* Ajusta el espacio entre las cartas */
