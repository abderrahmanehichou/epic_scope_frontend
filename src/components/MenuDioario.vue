...
<template>
    ...
    <h2 class="m-10 text-2xl font-bold text-red-800 text-center">Menu todos los días</h2>  
      <div class="flex justify-center gap-60 bg-red-800 pb-14 pt-14">
          <figure
            ref="flipContainer"
            ...
            v-for="menu in menues_diario" :key="menues_diario"
          >
            <!-- lado de adelante -->
            ...
            >
              ...
              <a href=""><h3 class=" text-white font-bold text-2xl bg-red-800 rounded ">Ver Menu</h3></a>
      
              
              
            </figcaption> 
          </figure>
         <!--  <h2 class="mb-2 text-2xl font-bold text-white"> Disponemos de menú vegetariano, vegano y celíaco</h2> -->
        </div>
        <h2 class="mb-10 pb-10 bg-red-800 text-3xl text-center font-bold text-white"> Disponemos de menú vegetariano, vegano y celíaco</h2>
    
      </template>
      
      <script setup>
      import { ref } from "vue";
      const menues_diario = ref(["Menú del día","Menú Txuletón","Menú Expres"]);
